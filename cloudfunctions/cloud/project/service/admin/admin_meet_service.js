...
class AdminMeetService extends BaseAdminService {
  ...
  async getJoinList({
    ...
    let fields =
      "JOIN_IS_CHECKIN,JOIN_CODE,JOIN_ID,JOIN_REASON,JOIN_USER_ID,JOIN_MEET_ID,JOIN_MEET_TITLE,JOIN_MEET_DAY,JOIN_MEET_TIME_START,JOIN_MEET_TIME_END,JOIN_MEET_TIME_MARK,JOIN_FORMS,JOIN_STATUS,JOIN_EDIT_TIME,JOIN_CARRY_TYPE,JOIN_CARRY_COUNT,JOIN_CARRY_NAMES";

module.exports = {
	...
	//### 环境相关 
	CLOUD_ID: 'cloud1-8gpxpeft5ed46735', //你的云环境id 
	...
	MEET_TYPE: '1=羽毛球场预约,2=匹克球预约,3=篮球场预约,4=乒乓球预约,5=网球场预约,6=游泳馆预约',
	// ##################################################################
	// #### 调试相关 
	TEST_MODE: false,  
	TEST_TOKEN_ID: '',

	COLLECTION_NAME: 'ax_admin|ax_cache|ax_day|ax_export|ax_internal_user|ax_join|ax_log|ax_meet|ax_news|ax_setup|ax_temp|ax_user',
